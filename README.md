...
![DevConf Landing Page](ui/DevConf%202026%20Landing%20Page%20Design.png)

![Hero Section](ui/Hero_Section.png)
...
- Inline Elements (`<span>`, `<a>`, `<em>`, `<img>`, ...)
- Block Elements (`<div>`, `<p>`, `<h1>`..`<h6>`, `<section>`, `<ul>`, `<ol>`, `<li>`, ...)
- Self-closing tags (also called void elements) (`<img>`, `<br>`, `<meta>`, ...)
